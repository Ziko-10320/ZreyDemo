...
public class GauntletTwinHealth : MonoBehaviour
{
    [Header("Health UI")]
    ...
    private GauntletTwinAttack followAI;
    ...
    private static readonly int GetCounteredGrabHash = Animator.StringToHash("GetCounteredGrab");
    ...
    void Awake()
    {
        ...
        currentHealth = maxHealth;
        currentGuard = maxGuard;
        followAI = GetComponent<GauntletTwinAttack>();
    ...
    public void ApplyDamageAndKnockback(AttackData attackData)
    {
        ...
        if (!isGuardBroken && !isInJuggleState && followAI != null && (followAI.IsAttacking() || followAI.IsLaunching() || followAI.IsAirLaunching()))
        {
    ...
    public void PlayGetCounteredGrab()
    {
        ...
        animator.SetTrigger(GetCounteredGrabHash);
    }
