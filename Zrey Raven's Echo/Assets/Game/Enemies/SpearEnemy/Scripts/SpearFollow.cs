...
[RequireComponent(typeof(SpearAttack))]
public class SpearFollow : MonoBehaviour
{
    ...
    private SpearHealth spearHealth;
    ...
    void Update()
    {
        ...
        if (playerTarget == null || (spearHealth != null && spearHealth.IsStunned()) || spearAttack != null && spearAttack.IsAttacking())
        {
        ...
        if (distanceToPlayer <= attackRange && !spearAttack.IsAttacking())
        {
            StopWalking();
            spearAttack.StartCombo();
        }
        else if (distanceToPlayer > attackRange && distanceToPlayer <= chaseRange && !spearAttack.IsAttacking())
        {
            StartWalking();
        }
        else
