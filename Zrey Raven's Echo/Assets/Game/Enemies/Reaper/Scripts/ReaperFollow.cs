...
[RequireComponent(typeof(ReaperAttack))]
public class ReaperFollow : MonoBehaviour
{
    ...
    private ReaperHealth ReaperHealth;
    ...
    void Awake()
    {
        ...
        ReaperHealth = GetComponent<ReaperHealth>();
    ...
    void Update()
    {
        ...
        if (playerTarget == null || (ReaperHealth != null && ReaperHealth.IsStunned()) || ReaperAttack != null && ReaperAttack.IsAttacking())
        {
        ...
        if (distanceToPlayer <= attackRange && !ReaperAttack.IsAttacking())
        {
            StopWalking();
            ReaperAttack.StartCombo();
        }
        else if (distanceToPlayer > attackRange && distanceToPlayer <= chaseRange && !ReaperAttack.IsAttacking())
        {
            StartWalking();
        }
        else
